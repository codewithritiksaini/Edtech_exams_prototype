              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                  ...
                  <div className="flex flex-row md:flex-col justify-end md:justify-center items-end gap-2 shrink-0">
                    ...
                    {slot.id && (
                      <Link
                        to={`/faculty/preview/delivery/${slot.id}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-indigo-200 bg-indigo-50/70 hover:bg-indigo-100 text-indigo-700 text-xs font-bold transition-all shadow-2xs cursor-pointer"
                        title="Preview student-facing delivery view for this day"
                      >
