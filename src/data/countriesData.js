// Auto-generated from seedCountryDetails.js
// Provides full countries list with names (no icons/flags)
...
export const countriesData = {
    ...
    DO: { name: 'Dominican Republic', phone: [1809, 1829, 1849] },
    ...
    HM: { name: 'Heard Island and McDonald Islands', phone: [61] },
    ...
    MM: { name: 'Myanmar (Burma)', phone: [95] },
    ...
    PN: { name: 'Pitcairn Islands', phone: [64] },
    PR: { name: 'Puerto Rico', phone: [1787, 1939] },
    ...
    SJ: { name: 'Svalbard and Jan Mayen', phone: [4779] },
    ...
    SX: { name: 'Sint Maarten', phone: [1721] },
    SY: { name: 'Syria', phone: [963] },
    SZ: { name: 'Eswatini', phone: [268] },
...
export const COUNTRIES_LIST = Object.entries(countriesData)
  .map(([code, item]) => ({
    code,
    name: item.name
  }))
